...
const FALLINGTEXT_MESSAGES = [
  ...
  "Chanh",
  "Thành",
  "Đôi khi thật khó nói lời tỏ tình",
  "8 năm",
  "Nhớ cậu nhiều",
  "Có thể không?",
  "Cậu là tất cả của tớ",
  "Thế giới này có cậu là đủ",
  "Không biết từ bao giờ, trái tim này đã rung động",
  "Đầu óc tớ trở nên trống rỗng khi nhìn thấy cậu",
  "Nhìn vào đôi mắt tớ chỉ thấy hình bóng cậu",
  "Tớ không muốn hai ta chỉ làm bạn",
  "Cậu là độc nhất không ai có thể thay thế với tó",
];
